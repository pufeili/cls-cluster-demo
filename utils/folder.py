...
class DatasetFolder(data.Dataset):
    ...
    def __init__(self, root, loader, extensions, transform=None, transform_aug=None, transform_gray=None):
        ...
        self.tgts = [s[1] for s in samples]
    ...
    def __getitem__(self, index):
        ...
        if (self.transform_gray is not None) and (self.transform_aug is not None):
            return sample, sample_aug, sample_gray, target
...
class ImageFolder(DatasetFolder):
    ...
    def __init__(self, root, transform=None, transform_aug=None, transform_gray=None, loader=default_loader):
